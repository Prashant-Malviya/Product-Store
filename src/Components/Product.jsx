    ...
    <div className="relative">
       <div className="border-gradient-br border border-amber-500 via-blue-500 to-purple-500 border-solid p-5 h-auto w-auto m-12 rounded-md lg:hover:scale-110 ease-in-out text-white">
        ...
        <span className="text-2xl font-bold mr-1">${product.price}</span>
          <span className="text-sm line line-through mt-2">${product.price + 255}</span>
        </span>
        ...
        <div className="flex justify-center items-center mt-3">
          <button className="px-5 py-2 text-center bg-slate-900 font-bold text-white lg:text-xl md:text-xl text-xs w-full flex justify-center rounded-md hover:bg-slate-800">
